...
namespace SchedulerMultiResAppointments {
    ...
    public partial class CarsDBDataSet : global::System.Data.DataSet {
        ...
        public partial class CarSchedulingDataTable : global::System.Data.TypedTableBase<CarSchedulingRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public CarSchedulingRow AddCarSchedulingRow(string CarId, int UserId, int Status, string Subject, string Description, int Label, System.DateTime StartTime, System.DateTime EndTime, string Location, bool AllDay, int EventType, string RecurrenceInfo, string ReminderInfo, decimal Price) {
...
namespace SchedulerMultiResAppointments.CarsDBDataSetTableAdapters {
    ...
    public partial class CarsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Cars] ([Model], [Picture]) VALUES (@Model, @Picture);\nSELECT ID, Mod" +
                "el, Picture FROM Cars WHERE (ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [Cars] SET [Model] = @Model, [Picture] = @Picture WHERE (([ID] = @Original" +
                "_ID) AND ((@IsNull_Model = 1 AND [Model] IS NULL) OR ([Model] = @Original_Model)" +
                "));\nSELECT ID, Model, Picture FROM Cars WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::SchedulerMultiResAppointments.Properties.Settings.Default.CarsXtraSchedulingConnectionString;
        }
        ...
        public virtual int Update(string Model, byte[] Picture, int Original_ID, string Original_Model, int ID) {
            if ((Model == null)) {
        ...
        public virtual int Update(string Model, byte[] Picture, int Original_ID, string Original_Model) {
            return this.Update(Model, Picture, Original_ID, Original_Model, Original_ID);
        }
    }
...
SELECT ID, CarId, UserId, Status, Subject, Description, Label, StartTime, EndTime, Location, AllDay, EventType, RecurrenceInfo, ReminderInfo, Price FROM CarScheduling WHERE (ID = @ID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, CarId, UserId, Status, Subject, Description, Label, StartTime, EndTime" +
                ", Location, AllDay, EventType, RecurrenceInfo, ReminderInfo, Price FROM CarSched" +
                "uling";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        public virtual int Update(
            ...
            if ((Original_Label.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[22].Value = ((int)(Original_Label.Value));
            }
            else {
            ...
            if ((Original_StartTime.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[24].Value = ((System.DateTime)(Original_StartTime.Value));
            }
            else {
            ...
            if ((Original_EndTime.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[26].Value = ((System.DateTime)(Original_EndTime.Value));
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[29].Value = ((bool)(Original_AllDay));
            if ((Original_EventType.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[30].Value = ((object)(0));
                this.Adapter.UpdateCommand.Parameters[31].Value = ((int)(Original_EventType.Value));
            }
            else {
